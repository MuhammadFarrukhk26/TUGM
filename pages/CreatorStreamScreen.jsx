  ...
  const performEndStream = async () => {
    try {
      ...
      if (!isActualCreator()) {
        Alert.alert(
          'Permission Denied',
          'Only the creator can end this stream.',
        );
      ...
      if (clientSecret) {
        ...
        if (initResponse.error) {
          ...
          if (paymentResponse.error) {
            ...
            const remainingSecsForBid = endTime
      ...
      if (diff <= 0) {
        ...
        const finalizeAuction = async () => {
          try {
            if (endingStream) {
              console.log(
                '⏹️ Stream already ending, skipping duplicate finalization',
              );
              return;
            }
            ...
            if (
              ...
              try {
                ...
                console.log(
                  'Note: Backend update may not be supported for unsold auctions.',
                );
              }
  ...
  useEffect(() => {
    ...
    socketRef.current.on('auctionTimeExtended', data => {
      ...
      if (data?.newEndTime) {
        ...
        ToastAndroid.show(
          '⏱️ Auction time extended! Keep bidding!',
          ToastAndroid.SHORT,
        );
      }
    });
    ...
    <View style={{ flex: 1 }}>
      <KeyboardAwareScrollView
        ...
        <View
          ...
          <TouchableOpacity
            onPress={() => {
              setShowProductCards(!showProductCards);
            }}
            style={{
              ...styles.commanStyle,
              width: 40,
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              handleBid(currentBid + (streamInfo?.bidIncrement || 2))
            }
            style={{
              backgroundColor:
                !isLiveAuction ||
            ...
            <View
              ...
              {giftsData?.map(i => (
                <Pressable
                  key={i?._id}
                  onPress={() => {
                    handleSendGifts(i?.coin, i?.title);
                  }}
                  style={{
        ...
        {showBid && (
          <View
            ...
            <View style={{ flexDirection: 'row', marginTop: 20 }}>
              ...
              <TouchableOpacity
                onPress={() => handleBid()}
                style={styles.startAuctionButton}>
        ...
        {showAuctionStartNotice && (
          <View
            ...
            <Text
              ...
              The current auction has ended. The host is preparing another
              auction now, please stay tuned.
            </Text>
            <View
              style={{
                flexDirection: 'row',
            ...
            {selectedProductForAuction && (
              <View style={{ alignItems: 'center', marginVertical: 15 }}>
                <Image
                  source={{
                    uri:
                      selectedProductForAuction?.images?.[0] ||
                      'https://via.placeholder.com/150',
                  }}
                  style={{
                    width: 60,
              ...
              <View
                ...
                <TouchableOpacity
                  onPress={() =>
                    setAuctionFormData({
                      ...auctionFormData,
                      suddenDeathEnabled: !auctionFormData.suddenDeathEnabled,
                    })
                  }
                  style={{
                    width: 20,
                    ...
                    borderWidth: 2,
                    borderColor: '#F78E1B',
                    backgroundColor: auctionFormData.suddenDeathEnabled
                      ? '#F78E1B'
                      : 'transparent',
                    marginRight: 10,
                    justifyContent: 'center',
            ...
            <Pressable
              onPress={() => {
                if (isLiveAuction) {
                  Alert.alert(
                    'Auction Mode',
                    'Add to Cart is disabled during live auction.',
                  );
                  return;
                }
                setshowShirts(true);
